...
-spec get_specs(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
-spec faces(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
%% @doc Return typefaces
-spec fontsize(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
fontsize(justify_report_hv, Tag)      ->
                                          ep_report_hv_sty:report_hv_fontsize(Tag);
fontsize(ragged_report_hv, Tag)       ->
                                          ep_report_hv_sty:report_hv_fontsize(Tag);
fontsize(preformatted_report_hv, Tag) ->
                                          ep_report_hv_sty:report_hv_fontsize(Tag);
fontsize(centered_report_hv, Tag)     ->
                                          ep_report_hv_sty:report_hv_fontsize(Tag);
fontsize(ragged_left_report_hv, Tag)  ->
                                          ep_report_hv_sty:report_hv_fontsize(Tag);

fontsize(cdoc, Tag)                   -> ep_cdoc_sty:cdoc_fontsize(Tag).

%% @doc Return max_linespace for readability
%% max_linespace/2 - Return return maximimum linespace for readability
-spec max_linespace(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
%% @doc Return leading
-spec leading(TypeStyle :: tuple(), Tag :: atom()) -> leading().
...
-spec justify(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
%% @doc Return indent
-spec indent(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
-spec times(Tag :: atom(), FontSize :: integer()) -> tuple().
times(ul, FontSize) ->
    {[ul],
...
-spec helvetica(Tag :: atom(), FontSize :: integer()) -> tuple().
...
-spec courier(Tag :: atom(), FontSize :: integer()) -> tuple().
courier(ul, FontSize) ->
    {[ul],
...
-spec tag_face(Tag :: atom(), Font :: string(), FontSize :: integer()) -> tuple().
...
-spec get_fontmap(TypeStyle :: tuple(), Tag :: atom()) -> tuple().
...
-spec list_faces(TypeStyle :: tuple(), Tag :: atom()) -> list().
...
-spec get_face(TypeStyle :: tuple(), StyleTag :: atom(), FaceTag :: atom()) -> tuple().
...
-spec face_map(TypeSyle :: tuple(), Tag :: atom()) -> map().
